...
**Charts**: lets you create interactive charts inside Obsidian - again, see this [post]({{< relref "obsidian-guide-1" >}}) for more details on how I use this.
{{<figure
